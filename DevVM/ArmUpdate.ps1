...
$chocoPackages = "visualstudio2017-workload-azure,7zip.install,azure-cli,azurepowershell,microsoftazurestorageexplorer,chocolateygui,curl,dotnet4.7,git.install,powershell,sysinternals,visualstudiocode,wget"
